    ...
    <div className="min-h-screen mystical-bg py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="glass-card rounded-2xl p-8">
          <h1 className="text-2xl md:text-3xl font-serif gradient-text mb-8">プライバシーポリシー</h1>
          <div className="text-gray-300 space-y-6 text-sm leading-relaxed">
            
            <section>
              <h2 className="text-lg text-gold mt-6 mb-3">1. はじめに</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg text-gold mt-6 mb-3">2. 収集する情報</h2>
            ...
            <section>
              <h2 className="text-lg text-gold mt-6 mb-3">3. 情報の利用目的</h2>
            ...
            <section>
              <h2 className="text-lg text-gold mt-6 mb-3">4. AIによる情報処理について</h2>
              <p>本サービスでは、AIキャラクターとの対話を実現するため、以下の情報処理を行います：</p>
              <ul className="space-y-2 list-disc list-inside mt-3">
            ...
            <section>
              <h2 className="text-lg text-gold mt-6 mb-3">5. 銀行口座情報の取り扱い</h2>
              <p>出金申請時にご登録いただく銀行口座情報は、以下のように取り扱います：</p>
              <ul className="space-y-2 list-disc list-inside mt-3">
            ...
            <section>
              <h2 className="text-lg text-gold mt-6 mb-3">6. 情報の保護</h2>
              <p>当サービスは、お客様の個人情報を適切に保護するため、以下の措置を講じています：</p>
              <ul className="space-y-2 list-disc list-inside mt-3">
            ...
            <section>
              <h2 className="text-lg text-gold mt-6 mb-3">7. 第三者への情報提供</h2>
              <p>当サービスは、以下の場合を除き、お客様の個人情報を第三者に提供することはありません：</p>
              <ul className="space-y-2 list-disc list-inside mt-3">
                <li>お客様の同意がある場合</li>
                <li>法令に基づく場合</li>
            ...
            <section>
              <h2 className="text-lg text-gold mt-6 mb-3">8. Cookieの使用</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg text-gold mt-6 mb-3">9. データの保持期間</h2>
              <p>各種データの保持期間は以下の通りです：</p>
              <ul className="space-y-2 list-disc list-inside mt-3">
            ...
            <section>
              <h2 className="text-lg text-gold mt-6 mb-3">10. お客様の権利</h2>
            ...
            <section>
              <h2 className="text-lg text-gold mt-6 mb-3">11. サービス利用履歴の管理</h2>
              <p>当サービスでは、以下の情報をシステムで管理しています：</p>
              <ul className="space-y-2 list-disc list-inside mt-3">
            ...
            <section>
              <h2 className="text-lg text-gold mt-6 mb-3">12. お問い合わせ</h2>
              <p>
