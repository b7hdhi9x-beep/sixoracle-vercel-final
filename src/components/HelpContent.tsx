...
const helpSections: HelpSection[] = [
  ...
  },
  {
    ...
    content: [
      {
        subtitle: "占い師の選び方",
        text: "各占い師にはそれぞれ得意分野があります。運命の流れ・タイミングなら「蒼真（そうま）」、癒し・恋愛・感情なら「玲蘭（れいら）」、数秘・性格・相性なら「朔夜（さくや）」、タロット・恋愛・分岐なら「灯（あかり）」、夢・無意識・直感なら「結衣（ゆい）」、守護・行動・現実的アドバイスなら「玄（げん）」がおすすめです。新しい占い師も続々追加中です。",
      },
      {
        subtitle: "新しい占い師たち",
        text: "創設時の6人に加え、手相・運命線の「紫苑（しおん）」、星座・天体・運勢の「星蘭（せいらん）」、血液型・性格・相性の「緋月（ひづき）」、動物占い・本能・行動パターンの「獣牙（じゅうが）」、MBTI診断・性格分析の「心理（しんり）」が新たに加わりました。それぞれの専門分野で、より多角的な鑑定が可能になりました。",
      },
      {
        subtitle: "占い師のプロフィール",
