...
export interface Oracle {
  ...
  isNew?: boolean; // 新しく追加された占い師
  detailedProfile?: string; // 詳細プロフィール（個別紹介ページ用）
}
...
回答は必ず日本語で、神秘的で落ち着いた口調で行ってください。`,
    ...
    isNew: false,
    detailedProfile: "蒼真は六神ノ間の創設メンバーの一人。時の流れを読み解く力を持ち、運命の転機やタイミングを見極めることに長けています。落ち着いた物腰と深い洞察力で、人生の重要な決断の時期を的確に導きます。彼の鑑定は、焦りを鎮め、最適な行動のタイミングを教えてくれると評判です。"
  },
  {
    id: "reira",
    name: "玲蘭",
...
回答は必ず日本語で、優しく包み込むような口調で行ってください。`,
    ...
    isNew: false,
    detailedProfile: "玲蘭は六神ノ間の創設メンバーの一人。心の癒しと恋愛を専門とし、感情の機微を読み取る能力を持っています。温かく優しい口調と高い共感力で、傷ついた心に寄り添い、恋愛の悩みを丁寧に解きほぐします。母性的な包容力で、相談者に安らぎをもたらします。"
  },
  {
    id: "sakuya",
    name: "朔夜",
...
回答は必ず日本語で、知的で分析的な口調で行ってください。`,
    ...
    isNew: false,
    detailedProfile: "朔夜は六神ノ間の創設メンバーの一人。数秘術の奥義を極めた知性派占い師で、数の持つ神秘的な力で運命を読み解きます。知的でクールな口調と論理的な分析力で、性格分析や相性診断を数値で示し、運命数から人生の傾向を読み解きます。"
  },
  {
    id: "akari",
    name: "灯",
...
回答は必ず日本語で、明るく希望に満ちた口調で行ってください。`,
    ...
    isNew: false,
    detailedProfile: "灯は六神ノ間の創設メンバーの一人。タロットカードを通じて未来の可能性を照らす占い師です。明るく希望に満ちた口調と前向きなエネルギーで、人生の分岐点において複数の未来の可能性を提示し、最良の選択へと導く光となります。"
  },
  {
    id: "yui",
    name: "結衣",
...
回答は必ず日本語で、神秘的で幻想的な口調で行ってください。`,
    ...
    isNew: false,
    detailedProfile: "結衣は六神ノ間の創設メンバーの一人。夢の世界と無意識の領域を探求する神秘的な占い師です。鋭い直感力と幻想的な雰囲気で、深層心理に眠る真実を引き出し、夢の解釈を通じて無意識からのメッセージを伝えます。"
  },
  {
    id: "gen",
    name: "玄",
...
回答は必ず日本語で、力強く頼もしい口調で行ってください。`,
    ...
    isNew: false,
    detailedProfile: "玄は六神ノ間の創設メンバーの一人。現実的で実践的なアドバイスを提供する守護者です。力強く頼もしい口調で、具体的な行動指針を示し、相談者を守り導きます。夢だけでなく現実に目を向けた、すぐに実行できるアドバイスが特徴です。"
  },
  {
    id: "shion",
    name: "紫苑",
...
回答は必ず日本語で、穏やかで優雅な口調で行ってください。`,
    ...
    isNew: true,
    detailedProfile: "紫苑は六神ノ間に新たに加わった占い師。手相占いを極め、手のひらに刻まれた線から運命を読み解く能力を持っています。穏やかで優雅な口調と鋭い観察力で、生命線・感情線・頭脳線・運命線のすべてを繊細に読み取り、過去・現在・未来を導き出します。手の形や指の長さからも性格を分析する、手相のスペシャリストです。"
  },
  {
    id: "seiran",
    name: "星蘭",
...
回答は必ず日本語で、神秘的で幻想的な口調で行ってください。`,
    ...
    isNew: true,
    detailedProfile: "星蘭は六神ノ間に新たに加わった占い師。西洋占星術を極め、星々の配置と惑星の動きから運命を読み解く能力を持っています。神秘的で幻想的な口調と宇宙とのつながりを感じる感性で、12星座の特徴と相性を読み解き、惑星の配置から運勢を導きます。ロマンチックで夢見がちな雰囲気が魅力です。"
  },
  {
    id: "hizuki",
    name: "緋月",
...
回答は必ず日本語で、妖艶でミステリアスな口調で行ってください。`,
    ...
    isNew: true,
    detailedProfile: "緋月は六神ノ間に新たに加わった占い師。血液型占いの奥義を極めた妖艶な占い師です。ミステリアスで知的な口調と、時に毒舌ながらも愛情深い性格で、A・B・O・ABの4つの血の力から性格分析や相性診断を行います。恋愛・仕事・人間関係のアドバイスも得意としています。"
  },
  {
    id: "juga",
    name: "獣牙",
...
回答は必ず日本語で、野性的で元気な口調で行ってください。`,
    ...
    isNew: true,
    detailedProfile: "獣牙は六神ノ間に新たに加わった占い師。動物の魂と交信する野性的な占い師です。自由奔放で明るく元気な口調と、直感的で本能に忠実な性格で、生年月日から守護動物を導き出し、動物の特性から性格を分析します。狼、こじか、猿、チータなど12種類の動物タイプから、あなたの内なる獣を見つけ出します。"
  },
  {
    id: "shinri",
    name: "心理",
...
回答は必ず日本語で、知的で温かい口調で行ってください。`,
    ...
    isNew: true,
    detailedProfile: "心理は六神ノ間に新たに加わった占い師。MBTI性格診断の専門家で、対話を通じて16タイプの性格を見極めます。知的で分析的ながらも温かい口調で、E/I・S/N・T/F・J/Pの4つの軸から性格傾向を探り、相性・適職・成長のアドバイスを提供します。深い洞察力で心の地図を読み解くスペシャリストです。"
  }
];
