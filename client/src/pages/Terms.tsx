  ...
  return (
    <div className="min-h-screen bg-background mystical-bg">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <h1 className="text-3xl md:text-4xl font-serif gradient-text mb-8">利用規約</h1>
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            <h2 className="text-xl font-serif text-gold mb-4">第1条（適用）</h2>
          ...
          <section>
            <h2 className="text-xl font-serif text-gold mb-4">第2条（サービスの定義）</h2>
            <p className="text-muted-foreground leading-relaxed">
              本サービスは、AI技術を活用した「デジタルコンパニオン」サービスです。
              10人の個性豊かなAIキャラクター（六神）との対話を通じて、以下の体験を提供します：
            </p>
          ...
          <section>
            <h2 className="text-xl font-serif text-gold mb-4">第3条（AI生成コンテンツに関する免責）</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-serif text-gold mb-4">第4条（エンターテインメント目的）</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-serif text-gold mb-4">第5条（医療・法律・金融アドバイスの禁止）</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-serif text-gold mb-4">第6条（親密度システムと特典）</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-serif text-gold mb-4">第7条（記憶機能について）</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-serif text-gold mb-4">第8条（料金および支払い）</h2>
            <p className="text-muted-foreground leading-relaxed">
              本サービスの料金体系は以下の通りです：
            </p>
            <ul className="text-muted-foreground space-y-2 list-disc list-inside mt-4">
              <li>月額プラン：1,980円（税込）・対話回数無制限・6人の占い師全員に相談可能・全機能利用可能・有効期間：30日間</li>
            </ul>
            <div className="text-muted-foreground leading-relaxed mt-4">
              <strong>支払方法：銀行振込のみ</strong><br/>
              <br/>
              【振込先口座】<br/>
          ...
          <section>
            <h2 className="text-xl font-serif text-gold mb-4">第9条（返金規定）</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-serif text-gold mb-4">第10条（解約）</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-serif text-gold mb-4">第11条（継続特典）</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-serif text-gold mb-4">第12条（禁止事項）</h2>
          ...
          <section>
            <h2 className="text-xl font-serif text-gold mb-4">第13条（年齢制限）</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-serif text-gold mb-4">第14条（サービスの変更・終了）</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-serif text-gold mb-4">第15条（準拠法・管轄裁判所）</h2>
            <p className="text-muted-foreground leading-relaxed">
